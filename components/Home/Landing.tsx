            ...
            <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              ...
              <div className="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
                <img
                  ...
                  src="https://res.cloudinary.com/raskin-me/image/upload/v1621802292/inviteable/Screen_Shot_2021-05-23_at_4.37.51_PM_cbwqd1.png"
                  alt=""
                />
              </div>
            </div>
          ...
          <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="relative rounded-2xl px-6 py-10 bg-red-500 overflow-hidden shadow-xl sm:px-12 sm:py-20">
              ...
              <div className="relative">
                ...
                <p className="mt-6 mx-auto max-w-2xl text-lg text-red-100 text-center">
                  Have a feature request? Contact me directly at{" "}
                  <a
